...
/* ─────────────────────────────────────────────
 *  Analysis Step (reuse existing loader)
 * ───────────────────────────────────────────── */
    ...
    return (
        ...
        >
            <div className="w-full max-w-lg">
                <AnalysisLoader onComplete={onComplete} />
            </div>
        </motion.div>
    )
}
 ...
 *  Preview Step
 * ───────────────────────────────────────────── */
function PreviewStep({ onUnlock }: { onUnlock: (email: string) => void }) {
    return (
        <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
            <div className="w-full max-w-lg">
                ...
                <PreviewCards onUnlock={onUnlock} />
            </div>
        </motion.div>
    )
}
 ...
 *  Report Step
 * ───────────────────────────────────────────── */
function ReportStep({ isUnlocked }: { isUnlocked: boolean }) {
    return (
        <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
    ...
    return (
        <section className="min-h-screen bg-background">
            ...
            <AnimatePresence mode="wait">
                ...
                {step === 'analysis' && (
                    <AnalysisStep key="analysis" onComplete={completeAnalysis} />
                )}

                {step === 'preview' && (
                    <PreviewStep key="preview" onUnlock={submitEmail} />
                )}

                {step === 'report' && (
                    <ReportStep key="report" isUnlocked={emailUnlocked} />
                )}
            </AnimatePresence>
