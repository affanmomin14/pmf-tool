...
export const PMF_FACTS = [
  ...
  { title: 'Retention > Growth', description: 'Companies with 40%+ monthly retention are 3x more likely to reach PMF.' },
  { title: 'Sean Ellis Test', description: 'If 40%+ users say they\'d be "very disappointed" without your product, you have PMF.' },
  { title: 'Channel-Market Fit', description: 'is as important as product-market fit. Most founders discover this too late.' },
  { title: 'The PMF Score', description: 'Companies scoring above 70 on PMF diagnostics raise 2.1x more in their next round.' },
]
...
export const PREVIEW_SIGNALS: PreviewSignal[] = [
  ...
  },
  {
    ...
    description: 'Your value proposition resonates but lacks differentiation clarity. Adjustable with messaging refinement.',
  },
  {
    type: 'strength',
    emoji: '🟢',
...
export const REPORT_SECTIONS: ReportSection[] = [
  {
    ...
    title: 'Reality Check',
    icon: '🔍',
    content: 'Based on your responses, your product shows early signs of value delivery but has critical gaps in distribution and positioning that must be addressed before scaling.',
    severity: 'warning',
    metrics: [
  ...
  },
  {
    ...
    icon: '📊',
    content: 'Your target market is viable but competitive. The segment you\'ve identified has 3-5 established players, but your unique angle on the problem creates whitespace opportunity.',
    severity: 'neutral',
    metrics: [
  ...
  },
  {
    ...
    icon: '🔄',
    content: 'Your retention signals suggest product value is being delivered, but the activation-to-habit loop has friction. Focus on reducing time-to-value in onboarding.',
    severity: 'positive',
    metrics: [
  ...
  },
  {
    ...
    icon: '🎯',
    content: 'Your one-liner needs sharpening. Users understand what you do but not why they should switch from their current solution. The "10x better" narrative is missing.',
    severity: 'warning',
    metrics: [
  ...
  },
  {
    ...
    icon: '📢',
    content: 'Your current channel shows promise but hasn\'t been validated at scale. Recommend testing 2 additional channels before doubling down on your primary.',
    severity: 'critical',
    metrics: [
  ...
  },
  {
    ...
    icon: '💰',
    content: 'Pricing signals indicate willingness to pay exists in your market. Consider value-based pricing tiers aligned with your strongest retention cohort.',
    severity: 'neutral',
    metrics: [
  ...
  },
  {
    ...
    icon: '🏰',
    content: 'Your substitution analysis reveals a moderate moat. Users have alternatives but prefer your approach. Strengthen this by building network effects or data advantages.',
    severity: 'warning',
    metrics: [
  ...
  },
  {
    ...
    icon: '⚠️',
    content: 'Your identified risk aligns with the most common pre-PMF failure pattern. Mitigation strategies are available and should be prioritized in your next sprint.',
    severity: 'critical',
    metrics: [
  ...
  },
  {
    ...
    icon: '🚀',
    content: 'Based on this analysis, your immediate priorities should be: (1) Sharpen positioning with the "switching" narrative, (2) Test 2 new distribution channels, (3) Instrument your activation funnel to identify drop-off points.',
    severity: 'positive',
    metrics: [
