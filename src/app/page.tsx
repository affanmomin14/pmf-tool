...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background">
      {/* Navigation */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-4 flex items-center justify-between glass-light"
      >
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#how-it-works" className="text-[13px] text-muted-foreground hover:text-foreground transition-colors duration-200">
            How it Works
          </a>
          <a href="#testimonials" className="text-[13px] text-muted-foreground hover:text-foreground transition-colors duration-200">
            Testimonials
          </a>
          <button
        ...
        {!showChat && (
          ...
          >
            <HeroSection
              ...
              analysisCount={MOCK_ANALYSIS_COUNT}
            />
            ...
            <section id="how-it-works" className="py-24 px-6">
              <div className="max-w-5xl mx-auto">
                ...
                >
                  ...
                  <h2 className="text-3xl md:text-[42px] leading-[1.15] text-foreground font-normal tracking-tight" style={{ fontFamily: 'var(--font-display)' }}>
                    Three minutes from question<br />to <span className="italic text-gradient">strategic clarity</span>
                  </h2>
                </motion.div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  {[
                    { step: '01', title: 'Pick your challenge', description: 'Select from 5 critical PMF dimensions — retention, positioning, distribution, monetization, or market fit.', icon: '🎯' },
                    { step: '02', title: 'Answer 5 questions', description: 'Our AI asks targeted questions and generates real-time micro-insights as you respond.', icon: '💬' },
                    { step: '03', title: 'Get your report', description: 'Receive a 9-section diagnostic with risk signals, strengths, and a Sprint 0 action plan.', icon: '📊' },
                  ].map((item, i) => (
                    <motion.div
                      key={item.step}
            ...
            <section id="testimonials" className="py-24 px-6">
              <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  {[
                    { quote: 'We were about to double down on paid ads. The PMF report showed us retention was the real problem. Saved months and $40K in ad spend.', name: 'Akash M.', role: 'Co-founder, NoteStack', metric: 'Saved $40K' },
                    { quote: 'The positioning audit was spot-on. We changed our homepage copy and saw a 34% increase in signup-to-activation.', name: 'Elena V.', role: 'CEO, Briefcase', metric: '+34% activation' },
                    { quote: 'Best free tool for early-stage founders. The Sprint 0 plan gave us a clear 4-week roadmap we actually executed.', name: 'Jordan T.', role: 'Founder, Climbr', metric: 'PMF in 8 weeks' },
                    { quote: 'I\'ve used every PMF framework out there. This is the only one that gives actionable insights, not just theory.', name: 'Priya S.', role: 'CTO, DataLayer', metric: '2x iteration speed' },
                  ].map((t, i) => (
                    <motion.div
                      key={t.name}
                      initial={{ opacity: 0, y: 16 }}
                    ...
                    >
                      <MagicCard
                        className="card-elevated p-7 h-full"
                        gradientColor="rgba(16, 185, 129, 0.05)"
                      >
                        <div className="flex items-center gap-2 mb-4">
                          <span
                            className="text-[11px] font-semibold px-2.5 py-1 rounded-full text-emerald-700 bg-emerald-50"
                          >
                            {t.metric}
                          </span>
                        </div>
                        <p className="text-[14px] text-muted-foreground leading-[1.7] mb-5">
                          &ldquo;{t.quote}&rdquo;
                        </p>
            ...
            <footer className="py-8 px-6 border-t border-border">
              <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #0F172A, #334155)' }}>
